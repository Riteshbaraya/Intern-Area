...
import { ArrowLeft, Check, Crown, Star, Zap, CreditCard, Clock, AlertCircle } from "lucide-react";
  ...
  return (
    <div className="min-h-screen bg-gray-50 py-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-8">
          ...
          <div className="mt-4 p-4 bg-yellow-50 border border-yellow-200 rounded-lg">
            ...
            <div className="text-xs text-yellow-700 space-y-1">
              ...
              <div>Current Plan: {currentPlan ? currentPlan.planName : 'None'}</div>
            </div>
            <button 
              onClick={() => {
        ...
        {/* Payment Time Warning - DISABLED FOR TESTING */}
        {false && (
          <div className="mb-6 bg-green-50 border border-green-200 rounded-lg p-4">
            <div className="flex items-center">
              <Clock className="h-5 w-5 text-green-400 mr-2" />
              <div>
                <h3 className="text-sm font-medium text-green-800">Payment Time Restriction - DISABLED</h3>
                <p className="text-sm text-green-700 mt-1">
                  Time restrictions are currently disabled for testing. Payments allowed at any time.
